/**
 * VexFlow Music Icon Generator - Node.js Script (ES Module)
 * 
...
// Import VexFlow from npm
import Vex from 'vexflow';

const { Renderer, Stave, StaveNote, Formatter, Dot, Accidental, 
        Beam, Tuplet, Articulation, Ornament } = Vex;
