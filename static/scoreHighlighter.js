...
import { getVexFlowNoteMap, getVexflowIndexByNoteId, getMeasureXPositions } from './scoreRenderer.js';
...
if (pianoState.currentSelectedNote && pianoState.currentSelectedNote.measureIndex === measureIndex) {
...
console.log(`clearMeasureHighlight: Removed DOM overlay for measure ${pianoState.currentSelectedMeasure}.`);
}

const previouslySelectedMeasureNotes = getMeasures()[pianoState.currentSelectedMeasure] || [];
...
setVexFlowNoteStyle(pianoState.currentSelectedMeasure, noteData.clef, vexflowIndex, defaultStyle);
}
});

if (pianoState.currentSelectedNote && pianoState.currentSelectedNote.measureIndex === pianoState.currentSelectedMeasure) {
