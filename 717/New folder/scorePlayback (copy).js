...
import { safeRedraw, addPlaybackHighlight, clearPlaybackHighlight, clearAllHighlights, scrollToMeasure } from './scoreRenderer.js'; // For visual score updates and scrolling
...
function scheduleNoteEvents(note, measureIndex, noteIndex, currentTransportTime, clefOffset, secondsPerBeat) {
    ...
    if (!note.isRest) {
        ...
        Tone.Transport.scheduleOnce(time => {
            Tone.Draw.schedule(() => {
                clearPlaybackHighlight(measureIndex, note.clef, noteIndex);
