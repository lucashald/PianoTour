...
let currentSelectedNote = null; // { measureIndex, clef, noteId } of the currently selected note
let currentPlaybackNote = null; // { measureIndex, clef, noteId } of the note currently being played
...
highlightSelectedMeasure(currentSelectedMeasure); 
}
...
addPlaybackHighlight(currentPlaybackNote.measureIndex, currentPlaybackNote.clef, currentPlaybackNote.noteId, '#FFD700'); 
}
...
const { measureIndex, clef, noteId } = currentSelectedNote; // Get details of the note to be cleared.
