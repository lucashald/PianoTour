...
Examples:
    ...
    python vexflow_to_midi.py song.json --output song.mid

    # JSON to MIDI (multiple instruments/symphony)
    python vexflow_to_midi.py piano.json guitar.json --output ensemble.mid

    # MIDI to JSON
    python vexflow_to_midi.py song.mid --to-json song.json
    python vexflow_to_midi.py song.mid --to-json  # prints to stdout
        """)
